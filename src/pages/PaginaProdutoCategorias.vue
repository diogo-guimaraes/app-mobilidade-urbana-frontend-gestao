        ...
        <template #body="props">
          <q-tr :props="props">
            ...
            <q-td key="produto">
              <q-item>
                <q-item-section>
                  <q-item-label class="text-bold"> {{ props.row.categoria }}</q-item-label>
                  <q-item-label class="estilo-coluna">
                    <div>Produto: {{ props.row.produto?.nome }}</div>
                    <div>Prioridade: {{ props.row.prioridade }}</div>
                  </q-item-label>
                </q-item-section>
              </q-item>
            </q-td>
...
const columns = [
  ...
  { name: 'produto', label: 'Categorias', align: 'left' },
